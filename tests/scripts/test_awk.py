...
def test_parse_block_header():
    awk_script_path = os.path.join(base_dir, "scripts", "awk", "parse_block_header.awk")
    input_file = os.path.join(base_dir, "tests/fixtures/scripts/awk/mock_aspect_log_v3_1_0.txt")
    expected_output = os.path.join(base_dir, "tests/fixtures/scripts/awk/expected_header_output_v3_1_0.txt")
    actual_dir = os.path.join(base_dir, "tmp/awk_tests")
    actual_output = os.path.join(base_dir, "tmp/awk_tests/test_header_output_v3_1_0.txt")
