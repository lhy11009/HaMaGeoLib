...
# vts file:
#   /home/lochy/ASPECT_PROJECT/HaMaGeoLib/big_tests/TwoDSubduction/test_visit_default/output/solution.visit
# directory for images:
#   /home/lochy/ASPECT_PROJECT/HaMaGeoLib/.test/research-haoyuan_2d_subduction-test_legacy_tools/img
...
def main():
    Temperature_Plot = TEMPERATURE_PLOT("/home/lochy/ASPECT_PROJECT/HaMaGeoLib/big_tests/TwoDSubduction/test_visit_default/output/solution.visit", output_dir="/home/lochy/ASPECT_PROJECT/HaMaGeoLib/.test/research-haoyuan_2d_subduction-test_legacy_tools/img")
    steps = [0]
    if type(steps) == list:
        for step in steps:
