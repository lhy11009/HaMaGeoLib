    ...
    if variables["include_fastscape"]:
        ...
        if use_all or "include_marine_component" in use_keys:
            if variables["include_marine_component"]:
                case_name += "_marine"
        if use_all or "silt_fraction" in use_keys:
            if variables["include_marine_component"]:
                case_name += "_SF%.2e" % variables["silt_fraction"]
        ...
        if mantle_rheology_scheme == "use_fluid":
            ...
            for composition in names_of_fields:
                ...
                for i in lower_mantle_phases[composition]:
                    ...
                    disl_A_dict[composition][i] = 1e-50  # set a big value in dislocation creep to turn it off
...
class WeakLayerRule(Rule):
    ...
    requires_comments = {"weak_layer_compositions": "The weak layer is expand to these compositions. Phase transitions of them are set up consistently.",
                         ...
                         "weak_layer_friction_factor": "If the user choose the low friction scheme, then the value of friction and cohesion are multiplied by this factor.",
                         "weak_layer_minimum_viscosity": "If the user choose the low friction scheme, then this value is used to set the minimum viscosity of the shear zone to prevent undershooting."}
...
class FastScapeRule(Rule):
    ...
    requires = ["include_fastscape", "topography_continent", "topography_different_ocean_continent", "include_initial_topography",
                ...
                "silt_fraction", "use_reflective_left_right", "use_ghost_nodes"]
    ...
    requires_comments = {"customize_no_incision_width": "This set a region at both left and right of the model domain with 0.0 incision rate",
                         ...
                         "silt_fraction": "Fraction of sediment leaving the continent that is silt.",
    ...
    def apply(self, config, prm_dict, wb_dict, context):
        ...
        silt_fraction = config["silt_fraction"]
        ...
        my_assert(
            0.0 <= silt_fraction <= 1.0,
            ValueError,
            "Silt fraction must be between 0 and 1",
        )
        ...
        if include_fastscape:
            ...
            if include_marine_component:
                ...
                fastscape_dict["Marine parameters"] = {
                    ...
                    "Silt fraction": str(silt_fraction)
                }
