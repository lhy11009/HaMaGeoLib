...
echo "rsync -avu --exclude=*restart* hive:"${selected_folder_hive}/${relative_case_path}/*" ."
# eval "rsync -avu --exclude=*restart* --exclude=*particle* hive:"${selected_folder_hive}/${relative_case_path}/*" ."
eval "rsync -avu --exclude=*restart* hive:"${selected_folder_hive}/${relative_case_path}/*" ."
